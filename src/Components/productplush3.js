    ...
    <section className="section product-detail">
      <div className="details container">
        <div className="left image-container">
          <div className="main">
          <img src={require("../images/keychain/keychain3.jpg")} id="zoom"/>
          </div>
        </div>
        <div className="right">
          <span>Home/Plush-Gấu Bông</span>
          <h1>Plush Maya Fey</h1>
          <div className="price">105.000đ</div>
          <form>
            <div>
              <select>
          ...
          <p>
            ...
            Hãy chọn chiêu hồn sư Maya Fey để triệu hồi linh hồn
