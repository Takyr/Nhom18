    ...
    <section className="section product-detail">
      <div className="details container">
        <div className="left image-container">
          <div className="main">
          <img src={require("../images/sticker/sticker3.jpg")} id="zoom"/>
          </div>
        </div>
        <div className="right">
          <span>Home/Board Games</span>
          <h1>7 Wonders 2nd Edition - 7 Kỳ Quan thế giới</h1>
          ...
          Nhiệm vụ của người lãnh đạo bao gồm tập trung nguồn lực, phát triển các tuyến thương mại, 
          và khẳng định uy quyền tối cao quân đội. Liệu bạn có thể phát triển được một thành phố 
          thịnh vượng và dựng lên kỳ quan kiến trúc trường tồn mãi theo thời gian.
          </p>
        </div>
      </div>
    </section>
