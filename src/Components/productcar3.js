    ...
    <section className="section product-detail">
      <div className="details container">
        <div className="left image-container">
          <div className="main">
          <img src={require("../images/clothes/clothes3.jpg")} id="zoom"/>
          </div>
        </div>
        <div className="right">
          <span>Home/Xe Đồ Chơi</span>
          <h1>Bộ Đồ Chơi Xe Tải Lắp Ráp Xanh</h1>
          ...
          <p>
            Bao gồm một bộ xe tải và 6 xe hơi mini kèm theo,
