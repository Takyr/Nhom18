...
import {auth, Auth, db} from '../firebaseConfigs/firebaseConfig'
        ...
        createUserWithEmailAndPassword(auth, email, password)
            .then((userCredential) => {
                ...
                addDoc(collection(db, "users"), {
                    ...
                    setSuccessMSG('Them user thanh cong')
                    setUserName('')
                    setEmail('')
                    setPassword('')
                    setErrorMSG('')
            ...
            .catch((error) => {
                ...
                {
                    setErrorMSG('Xin hãy nhập đủ thông tin.')
  ...
  <Link to="" className="nav-link">Shop</Link>
      ...
      <div className="login-form">
        <form action="">
          <h1> Đăng Kí</h1>
          <p>
 Xin hãy điền vào form này để tạo tài khoản, hoặc
