    ...
    <section className="section product-detail">
      <div className="details container">
        <div className="left image-container">
          <div className="main">
          <img src={require("../images/keychain/keychain1.jpg")} id="zoom"/>
          </div>
        </div>
        <div className="right">
          <span>Home/Plush-Gấu Bông</span>
          <h1>Plush Phoenix Wright</h1>
          ...
          <p>
            ...
            Hãy chọn luật Sư Phoenix Wright để giúp bạn thắng phiên tòa
