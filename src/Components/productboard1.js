    ...
    <section className="section product-detail">
      <div className="details container">
        <div className="left image-container">
          <div className="main">
          <img src={require("../images/sticker/sticker1.jpg")} id="zoom"/>
          </div>
        </div>
        <div className="right">
          <span>Home/Board Games</span>
          <h1>Ticket To Ride: Europe - Chuyến tàu vòng quanh Châu Âu</h1>
          <div className="price">450.000đ</div>
          <form>
            <div>
              <select>
          ...
          <p>
          Ticket to ride là một trong những board game phiêu lưu phổ biến nhất tại thời điểm hiện tại. 
          Nhiệm vụ của trò chơi là cùng nhau kết nối các thành phố trên bản đồ, xây dựng những đoàn tàu dài 
          để nối các nước ở khu vực Bắc Mỹ lại với nhau. Với thể loại game chiến lược như vậy, Ticket to Ride 
          là một sự lựa chọn hoàn hảo cho những ai có hứng thú với việc xây dựng và điều khiển một hệ thống.
          </p>
        </div>
      </div>
    </section>
