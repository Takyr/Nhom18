    ...
    <section className="section product-detail">
      <div className="details container">
        <div className="left image-container">
          <div className="main">
          <img src={require("../images/clothes/clothes1.jpg")} id="zoom"/>
          </div>
        </div>
        <div className="right">
          <span>Home/Xe Đồ Chơi</span>
          <h1>Xe Đua Lắp Ráp Vàng-Xanh</h1>
          ...
          <p>
            Xe có thể được tháo lắp 4 bánh xe và kèm theo một máy khoan đồ chơi,
